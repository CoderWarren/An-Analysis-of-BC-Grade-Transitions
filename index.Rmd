...
```{r plot-2, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 2: Heatmap displaying the trend in overall transition rates for various students for each district over the years."}
