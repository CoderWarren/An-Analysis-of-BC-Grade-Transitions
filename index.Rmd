...
teacher_1 <- read_excel("data_districts/legacy-teacher-statistics-19911992-20162017.xlsx")
...
```{r heaty, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 5: Heatmap displaying the trend in overall transition rates for various students for each district over the years."}

# Generate our heat map matrices for each grade
heatmap_mat1 <- gen_heatmap_mat(1)
heatmap_mat2 <- gen_heatmap_mat(2)
heatmap_mat3 <- gen_heatmap_mat(3)
heatmap_mat4 <- gen_heatmap_mat(4)
heatmap_mat5 <- gen_heatmap_mat(5)
heatmap_mat6 <- gen_heatmap_mat(6)
heatmap_mat7 <- gen_heatmap_mat(7)
heatmap_mat8 <- gen_heatmap_mat(8)
heatmap_mat9 <- gen_heatmap_mat(9)
heatmap_mat10 <- gen_heatmap_mat(10)
heatmap_mat11 <- gen_heatmap_mat(11)

# Generate our text labels

# The actual 
plot_ly(x=colnames(heatmap_mat1), 
        y=rownames(heatmap_mat1), 
        type="heatmap",
        zmin=20,
        zmax=100,
        showscale=FALSE) %>%
  add_trace(z=heatmap_mat1, visible=TRUE, coloraxis = 'coloraxis', name="Grade 1") %>%
  add_trace(z=heatmap_mat2, visible=FALSE, coloraxis = 'coloraxis', name="Grade 2") %>%
  add_trace(z=heatmap_mat3, visible=FALSE, coloraxis = 'coloraxis', name="Grade 3") %>%
  add_trace(z=heatmap_mat4, visible=FALSE, coloraxis = 'coloraxis', name="Grade 4") %>%
  add_trace(z=heatmap_mat5, visible=FALSE, coloraxis = 'coloraxis', name="Grade 5") %>%
  add_trace(z=heatmap_mat6, visible=FALSE, coloraxis = 'coloraxis', name="Grade 6") %>%
  add_trace(z=heatmap_mat7, visible=FALSE, coloraxis = 'coloraxis', name="Grade 7") %>%
  add_trace(z=heatmap_mat8, visible=FALSE, coloraxis = 'coloraxis', name="Grade 8") %>%
  add_trace(z=heatmap_mat9, visible=FALSE, coloraxis = 'coloraxis', name="Grade 9") %>%
  add_trace(z=heatmap_mat10, visible=FALSE, coloraxis = 'coloraxis', name="Grade 10") %>%
  add_trace(z=heatmap_mat11, visible=FALSE, coloraxis = 'coloraxis', name="Grade 11") %>%
  layout(
  ...
  updatemenus = list(
    list(
      ...
      buttons=list(
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 1), TRUE, rep(FALSE, 9)))),
             label = "Grade 1"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 2), TRUE, rep(FALSE, 8)))),
             label = "Grade 2"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 3), TRUE, rep(FALSE, 7)))),
             label = "Grade 3"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 4), TRUE, rep(FALSE, 6)))),
             label = "Grade 4"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 5), TRUE, rep(FALSE, 5)))),
             label = "Grade 5"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 6), TRUE, rep(FALSE, 4)))),
             label = "Grade 6"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 7), TRUE, rep(FALSE, 3)))),
             label = "Grade 7"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 8), TRUE, rep(FALSE, 2)))),
             label = "Grade 8"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 9), TRUE, rep(FALSE, 1)))),
             label = "Grade 9"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 10), TRUE, rep(FALSE, 0)))),
             label = "Grade 10"),
        list(method = "restyle",
             args = list("visible", as.list(c(rep(FALSE, 0), TRUE, rep(FALSE, 10)))),
             label = "Grade 11")
    ))))
```
