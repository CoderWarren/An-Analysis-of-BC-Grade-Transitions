...
```{r plot3, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 2: An interactive graph depicting the percentage of high school BC students that successfully transition to the next grade between the years 1993 and 2020."}
district_plot_2
```
