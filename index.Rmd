...
district_plot <- data_district %>%  # Code for the plot
  plot_ly(x = ~year, 
          y=~rate, 
          type="scatter", 
          mode="line",
...
```{r plot2, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="A graph depicting the percentage of high school BC students that successfully transition to the next grade between the years 1993 and 2020."}
district_plot
```
